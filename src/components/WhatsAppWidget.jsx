...
const WhatsAppWidget = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end gap-3">
      {/* Tooltip / Chat Bubble */}
      <div 
        className={`hidden md:block relative bg-white text-slate-800 p-4 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.1)] border border-emerald-100 max-w-[200px] transition-all duration-500 origin-bottom-right ${
