...
const AppointmentCTA = () => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative w-full min-h-[40vh] sm:min-h-[50vh] flex items-center justify-center py-10 sm:py-14 px-6 md:px-12 lg:px-20 overflow-hidden bg-emerald-950"
    >
      ...
      <div className="max-w-7xl mx-auto w-full relative z-20 grid grid-cols-1 lg:grid-cols-10 items-center gap-16 lg:gap-8">
        ...
        <div ref={leftContentRef} className="lg:col-span-6 flex flex-col text-left">
          ...
          <div className="paragraph text-gray-200 text-base md:text-lg leading-relaxed max-w-xl mb-10 space-y-4 font-light">
            <p>
          ...
          <div className="contact-info opacity-0 mt-12 border-t border-emerald-500/10 pt-8 flex flex-col sm:flex-row sm:items-start gap-8 sm:gap-12">
            ...
            {/* Phone */}
            <div className="flex flex-col text-left group cursor-pointer pt-2">
              <span className="text-gray-300 font-semibold text-[10px] tracking-[0.18em] uppercase mb-1">
                CALL US TODAY
              </span>
              <a
                href="tel:+918919942870"
                className="flex items-center gap-2.5 text-xl font-medium text-white group-hover:text-emerald-400 transition-colors duration-300"
              >
            ...
            <div className="flex flex-col text-left max-w-xs">
              ...
              <div className="max-w-2xl text-base sm:text-lg text-emerald-100/90 font-light leading-relaxed flex flex-col gap-4">
