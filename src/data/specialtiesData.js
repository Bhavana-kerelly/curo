export const specialtiesData = [
  ...
  },
  {
    ...
    treatments: [
      'Professional Ear Wax Removal / Ear Cleaning',
    ...
    conditions: [
      'Ear Wax Build-Up & Ear Blockage',
      'Hearing Loss & Hearing Difficulties',
      'Foreign Bodies of the Ear, Nose & Throat',
      'Nasal & Sinus Problems',
      'Throat & Voice-Related Conditions',
      'Ear Injuries & Auricular Hematoma'
    ],
    procedures: [
      'Diagnostic Nasal Endoscopy',
      'Videolaryngoscopy',
      'Precision Otoscopic Examination',
      'Audiological Assessment',
      'Minor ENT Procedures (Keloid Excision, Ear Lobe Repair, Auricular Hematoma I&D)'
    ],
    whyChooseUs: [
      'Comprehensive evaluation of ear, nose, and throat conditions under one roof.',
      'Advanced diagnostic tools including nasal endoscopy, videolaryngoscopy, and otoscopy.',
      'Professional ear wax and foreign body removal using appropriate clinical techniques.',
      'Specialized care for ear injuries, keloids, ear lobe conditions, and auricular hematoma.',
      'Hearing assessment and audiological evaluation for patients experiencing hearing difficulties.'
    ],
    hours: 'Mon - Sat: 10:00 AM - 9:00 PM | Sun: 10:00 AM - 1:00 PM',
    emergency: 'Urgent ENT Consultation & Foreign Body Removal'
  },
  {
    id: 'surgery',
